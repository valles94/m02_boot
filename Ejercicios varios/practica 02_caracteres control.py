...
def ingresar_productos(precio):
    ...
    if precio == "0": # esta linea realmente no sirve para nada, solo añade un espacio para separar el tiket de los productos
        print()
    return precio
...
def Ticket():
    ...
    print(f"{aImprimir}\n - - - - - - -\nTotal: {precio_total}€\nUnidades: {total_items}")


##print("\n033[estilo;colortexto;colorfondom]") con esta formula podemos modificar y formatear los resultados, acoerdarse de añadir la M detras del color d fondo
